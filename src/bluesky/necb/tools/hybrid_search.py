...
from bluesky.necb.tools.model_config import get_optimal_embedding_model
...
def main():
    ...
    from bluesky.necb import DB_PATH, CHROMA_PATH
    ...
    if not args.chroma.exists():
        ...
        print("Run: python -m bluesky.necb.tools.vector_indexer")
        sys.exit(1)
